...
git pull >> buidLog 2>> buidLog
echo Running maven
mvn install >> buidLog 2>> buidLog
echo Building ember
cd ~/transparentPolitics/trpo/
ember build >> buidLog 2>> buidLog
echo Shutting down tomcat
shutdown_tomcat >> buidLog 2>> buidLog
...
jar xvf ~/tomcat/webapps/ROOT/trapol.war >> buidLog 2>> buidLog
...
cd ~/tomcat/bin
sh startup.sh >> buidLog 2>> buidLog
echo Finished!!
